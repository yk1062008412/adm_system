 ...
 * @LastEditTime: 2019-12-02 23:56:46
 ...
 <template>
  <el-table :data="list" stripe style="width: 100%" size="small" empty-text="暂无数据">
    ...
    <el-table-column prop="address" label="操作" width="200">
      ...
      <el-button type="success" icon="el-icon-upload2" circle size="mini" />
      <el-button type="warning" icon="el-icon-download" circle size="mini" />
